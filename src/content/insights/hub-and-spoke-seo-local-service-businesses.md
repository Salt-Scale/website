---
title: "Hub-and-spoke SEO: why local service businesses don't need 165 pages to rank"
description: "Most local SEO advice gets it wrong. Here's the honest breakdown of what actually works for service-area businesses, and when combo pages help vs. hurt."
...
- A verified [Google Business Profile](https://business.google.com/). This does more for local map-pack rankings than anything on your website.
- A [`LocalBusiness` schema](https://schema.org/LocalBusiness) with consistent name, address, and phone number.
- One page per service. Not one paragraph; a real page.
...
The catch: Google has a specific penalty for [doorway pages](https://developers.google.com/search/docs/essentials/spam-policies#doorway-pages). Pages whose only real difference is the city name swapped in. If your "Water Heater Installation in Katy" page and your "Water Heater Installation in Sugar Land" page are 95% identical, you're not helping your rankings. You're diluting them. In some cases Google indexes one and ignores the rest. In others it pulls both down.
...
1. You have real search volume data showing people are searching *water heater installation [city]* in your market.
2. You can write genuinely unique content. Local concerns, local context, real customer stories from that city.
3. You start with your highest-value service × highest-population cities. Not all 165 at once.
